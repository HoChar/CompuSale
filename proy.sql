...
('01', 'ALIENWARE M15', 'El portátil de 15 pulgadas más fino de Alienware hasta el momento. Con una regulación de voltaje de 8 fases de alta eficiencia opcional, la tecnología de refrigeración Cryo-Tech 3.0 y un nuevo y diseño industrial Legend.', 6146949),
('02', 'ALIENWARE M17', 'El portátil de 43,1 cm o 17 pulgadas más compacto de Alienware hasta el momento. Con una regulación de voltaje de 8 fases de alta eficiencia opcional, la tecnología de refrigeración Cryo-Techv3.0 & nuevoy legendario diseño industrial.', 6762054),
('03', 'ALIENWARE AREA-51M', 'Un revolucionario portátil para juegos de 17 pulgadas que incorpora un procesador de sobremesa Intel® Core™ de 9.ª generación actualizable y sobreacelerable, una tarjeta gráfica NVIDIA® GeForce RTX™ y un chasis de aleación de magnesio.', 9017398),
('04', 'Asus X512fb', 'El ASUS VivoBook 15 es un compacto portátil que pronuncia la sensación de inmersión cuando trabajas o te relajas con tus contenidos favoritos. Rodeada de marcos de 5,7 mm y con una relación pantalla-cuerpo del 88 %, la nueva pantalla NanoEdge ofrece un nivel de inmersión visual espectacular. La bisa', 1899000),
('05', 'Acer 53lp', 'Explora y disfruta un nuevo nivel de Gaming más inmersivo con la pantalla Full HD y la potente tecnología del Nitro 5.', 2869000),
('06', 'Lenovo S145', 'Diseñada para ofrecer un rendimiento duradero, la IdeaPad S145 ofrece un procesamiento potente y fluido con un diseño elegante y ligero. Perfecta para realizar tus tareas informáticas diarias desde cualquier parte, esta portátil duradera de 14\" ofrece un magnífico sonido y opciones de almacenamiento', 895000),
('07', 'HP Gamer I5-9300h', 'El procesador Intel® Core™ i5 de cuatro núcleos de 9.ª generación más reciente, gráficos dedicados avanzados NVIDIA® GeForce® GTX 1050 y una pantalla de alta resolución con velocidad de actualización rápida.', 2600000),
('08', 'Zen AiO', 'Creemos que la tecnología puede ser hermosa, y Zen AiO es la prueba definitiva. Su construcción unibody sin costuras está fabricada con precisión con un acabado de efecto metálico en glamoroso Quartz Grey, detalles de metal hilado inspirados en Zen y un elegante soporte integrado, Zen AiO no es solo', 2700000),
('09', 'Acer Aspire Z24-890-UA91 AIO', 'Desktop de 23,8 pulgadas Full HD, Intel Core i5-9400T, 12 GB DDR4, 512 GB SSD, Wi-Fi 802.11ac, USB 3.1 tipo C, teclado y ratón inalámbricos, Windows 10 Home, color plateado, Plateado', 2869041),
